...
TEST_CASE("wide_encoding::decode(InputIt, InputIt, char32") {
  // TODO(bitwize): add tests
}

//-----------------------------------------------------------------------------

TEST_CASE("wide_encoding::encode(char32, OutputIt, char8)") {
  // TODO(bitwize): add tests
}

//-----------------------------------------------------------------------------

TEST_CASE("wide_encoding::next(ForwardIt, ForwardIt)") {
  // TODO(bitwize): add tests
}
